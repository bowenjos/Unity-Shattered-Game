...
public class WilliamThirdInteraction : CharacterInteraction
{
    ...
    void Start()
    {
        ...
        dialogue[0][2] = "I'm supposed to be playing tonight, but it's the first time I'll have played for an Audience.";
        dialogue[0][3] = "Before this, Elise was the only person who has ever seen me play.";
        dialogue[0][4] = "Now, lets go find those actors.";
    }
